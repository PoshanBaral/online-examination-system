    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Poshan Baral </a>
		...
		<h4 style="font-family:'typo' ">BTI,Bangalore</h4></div></div>
		</p>
      </div>
      <div class="modal-body">
        <p>
		...
		<div class="col-md-4">		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Shiv Raj Kshetri </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9841502961</h4>
		<h4 style="font-family:'typo' ">shivraj@gmail.com</h4>
		<h4 style="font-family:'typo' ">BTI,Bangalore</h4></div></div>
		</p>
      </div>
